 ...
 * In this example I'll have an abstract class representing different types of devices. 
 * I also have an abstract class that will represent different types of remote controls
 * 
