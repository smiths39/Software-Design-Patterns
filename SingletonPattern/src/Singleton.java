...
public class Singleton {
	...
	/* 
	 * We could make getInstance a synchronized method to force every thread to wait its turn. 
	 * That way only one thread can access a method at a time. 
	...
	public LinkedList<String> getTiles(int howManyTiles) {
	     ...
	     * Strings to the to be returned LinkedList while deleting them from letterList
		 */ 
